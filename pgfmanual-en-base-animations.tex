...
documented in the following.
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-1.svg}]
\tikz {
...
\begin{command}{\pgfanimateattribute\marg{attribute}\marg{options}}
    ...
    effect:
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-2.svg}]
\tikz {
  \pgfanimateattribute{opacity}{
    whom = node, begin on = {click}, entry = {0s}{1}, entry = {2s}{0} }
  \node (node) [fill = blue!20, draw = blue, very thick, circle] {Click me!};
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animation/name=\meta{name}}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-3.svg}]
\tikz [very thick] {
...
\begin{key}{/pgf/animation/entry=\marg{time}\marg{value}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-4.svg}]
\tikz {
  \pgfanimateattribute{rotate}{
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animations/exit control=\marg{time fraction}\marg{value fraction}}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-5.svg}]
\tikz {
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animations/stay}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-6.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \pgfanimateattribute{translate}{
    whom = node, begin on = {click},
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animations/jump}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-7.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \pgfanimateattribute{translate}{
    whom = node, begin on = {click},
...
\begin{key}{/tikz/animations/base=\meta{value}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-8.svg}]
\tikz {
  \pgfanimateattribute{rotate}{
    whom = node, begin on = {click},
...
\begin{animateattribute}{fill}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-9.svg}]
\tikz {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-10.svg}]
\tikz {
...
scope:
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-11.svg}]
\tikz {
  \pgfanimateattribute{fill}{
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-12.svg}]
\tikz {
  \pgfanimateattribute{fill}{
    whom = example, begin on = {click, of next=node},
    entry = {0s}{white}, entry = {2s}{red} }
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-13.svg}]
\tikz {
  \pgfanimateattribute{fill}{
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-14.svg}]
\tikz {
  \pgfanimateattribute{fill}{
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-15.svg}]
\tikz {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-16.svg}]
\tikz {
...
\begin{animateattribute}{opacity}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-17.svg}]
\tikz {
  \pgfanimateattribute{opacity}{
    whom = node, begin on = {click}, entry = {0s}{1}, entry = {2s}{0} }
  \node (node) [fill = blue!20, draw = blue, very thick, circle] {Click me!};
...
\begin{animateattribute}{visible}
    ...
    |true|.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-18.svg}]
\tikz {
...
\begin{animateattribute}{stage}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-19.svg}]
\tikz {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-20.svg}]
\tikz [very thick] {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-21.svg}]
\tikz {
...
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-22.svg}]
\tikz {
  \pgfanimateattribute{dash}{
...
\begin{animateattribute}{path}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-23.svg}]
\tikz {
...
\begin{key}{/pgf/animation/arrows=\meta{start tip spec}|-|\meta{end tip spec}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-24.svg}]
\tikz {
  \pgfanimateattribute{path}{
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-25.svg}]
\tikz {
  \pgfanimateattribute{path}{
    whom = p.path, begin on = {click, of next=node}, arrows = ->,
...
\begin{key}{/pgf/animation/shorten >=\meta{dimension}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-26.svg}]
\tikz {
  \pgfanimateattribute{path}{
    whom = p.path, begin on = {click, of next=node}, arrows = ->,
    shorten > = 2mm,
...
\begin{animateattribute}{scale}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-27.svg}]
\tikz [very thick] {
...
\begin{animateattribute}{rotate}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-28.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
    whom = node, begin on = {click},
...
\begin{animateattribute}{xskew}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-29.svg}]
\tikz [very thick] {
...
\begin{animateattribute}{translate}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-30.svg}]
\tikz [very thick] {
  \pgfanimateattribute{translate}{
    whom = node, begin on = {click},
...
\begin{key}{/pgf/animation/origin=\meta{pgf point}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-31.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
    whom = node, begin on = {click},
...
\begin{animateattribute}{motion}
    ...
    |motion| attribute:
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-32.svg}]
\tikz [very thick] {
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animation/along=\meta{path}}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-33.svg}]
\tikz [very thick] {
  \pgfanimateattribute{motion}{
    whom = node, begin on = {click},
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animation/rotate along=\meta{Boolean} (default true)}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-34.svg}]
\tikz [very thick] {
  \pgfanimateattribute{motion}{
    whom = node, begin on = {click},
    rotate along = true,
...
\begin{animateattribute}{view}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-35.svg}]
\tikz [very thick] {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-36.svg}]
\tikz [very thick] {
  \pgfanimateattribute{view}{
...
\begin{key}{/pgf/animation/end=\meta{time}}
    ...
    4\,s.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-37.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\begin{key}{/pgf/animation/freeze at end=\meta{true or false} (default true, initially false)}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-38.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-39.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\begin{key}{/pgf/animation/repeats=\meta{specification}}
    ...
    \begin{itemize}
        \item Empty, in which case the timeline repeats forever.
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-40.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\end{codeexample}
        ...
        \item A \meta{number} (like |2| or |3.25|), in which case the timeline
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-41.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\end{codeexample}
        ...
        \item The text ``|for| \meta{time}'' (like |for 2s| or |for 300ms|), in
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-42.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\end{codeexample}
    ...
    \begin{itemize}
        ...
        \item The text |accumulating|. This has the effect that each time the
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-43.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
...
\end{codeexample}
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-base-animations-animation-44.svg}]
\tikz [very thick] {
  \pgfanimateattribute{rotate}{
